...
import com.example.glacomplex.databinding.ItemCartBinding;
import com.example.glacomplex.databinding.QuantityDialogBinding;
                ...
                quantityDialogBinding.plusBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(quantity > product.getStock()){
                            Toast.makeText(context, "Max stock avilable: "+ product.getStock(), Toast.LENGTH_SHORT).show();
                            return;
                        } else {
